...
subsection \<open>has_sgnx / sgnx_able / sgnx\<close>    
...
proof -
  ...
  proof -
    have "?l1s = (op * (1/2)) ` ?ls l1" by (auto intro:rev_image_eqI)
  ...
  proof -
    ...
    proof - 
      have "isCont f x" 
        ...
        using insertI_2.hyps(1) that apply auto[2]
...
subsection \<open>jumpF_pathstart and jumpF_pathfinish\<close>  
...
proof -
  ...
  proof (rule jumpF_cong)
    show " \<forall>\<^sub>F x in at_right 0. (?h \<circ> op * 2) x =?f x"
      unfolding eventually_at_right
...
proof -
  ...
  proof -
    ...
    proof -
      have "cindexE 0 (1/2) (f (g1+++g2)) = cindexE 0 (1/2) (f g1 o (op * 2))"
