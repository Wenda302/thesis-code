...
section \<open>Evaluating winding numbers\<close>
...
text \<open>
The method "eval_winding" will try to simplify of the form @{term "winding_number g z = n"} where 
