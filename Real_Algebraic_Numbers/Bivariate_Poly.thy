...
subsection \<open>Mapping bivariate polynomials\<close>
...
subsection \<open> @{typ "rat bpoly"} to @{typ "int bpoly"} by clearing the denominators\<close>
