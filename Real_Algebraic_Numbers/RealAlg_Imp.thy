...
section \<open>Implementation of real algebraic numbers\<close>

subsection{*of_float_poly*}
...
subsection{*pseudo remainder sequence*}
...
subsection{*Real algebraic number*}
...
subsection \<open>Univariate sign determination procedure\<close>
...
subsection \<open>Bivariate sign determination procedure\<close>
