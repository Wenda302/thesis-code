...
(*to work around a mysterious bug in Isabelle2016-1, otherwise the version above should used*)
fun gcd (x,y) = zz_gcd x y;
fun lcm (x,y) = zz_lcm x y;
...
(*Integer powers, positive or negative.*)
fun exp (r, Rat (true, n, 1))  = Useful.exp mult r n one
  | exp (r, Rat (false, n, 1)) = Useful.exp mult (inv r) n one
